...
function(cmi_add_subdirectory PROJECT_NAME_)
  ...
  cmake_parse_arguments(CMI_ADD_SUBDIRECTORY "" "OPTIONAL" "" ${ARGN})
  ...
  if(${CMI_ENABLE_PREFIX}${PROJECT_NAME_UPPER_})
    ...
    if(EXISTS ${${PROJECT_NAME_UPPER_}_DIR})
      set_property(GLOBAL PROPERTY ${PROJECT_NAME_UPPER_}_INCLUDED "TRUE")
      add_subdirectory("${${PROJECT_NAME_UPPER_}_DIR}" "${CMAKE_CURRENT_BINARY_DIR}/${PROJECT_NAME_LOWER_}")
    else()
...
macro(cmi_load_build_environment)
  ...
  set(CMAKE_LIBRARY_OUTPUT_DIRECTORY "${CMI_LIBRARY_OUTPUT_DIRECTORY}" CACHE INTERNAL "")
  set(CMAKE_RUNTIME_OUTPUT_DIRECTORY "${CMI_RUNTIME_OUTPUT_DIRECTORY}" CACHE INTERNAL "")
...
function(cmi_Fortran_append var name)
  ...
  set(Fortran_OMP_Linux_GNU "-fopenmp -D_OMP")
  set(Fortran_OMP_CYGWIN_GNU "-fopenmp -D_OMP")
  set(Fortran_OMP_Linux_Intel "-qopenmp -D_OMP")
  set(Fortran_OMP_Windows_Intel "/Qopenmp /D_OMP")
...
macro(cmi_find_python)
  ...
  if(DEFINED _COMPONENTS)
    foreach(_COMPNENT IN LISTS _COMPONENTS)
      if(_COMPNENT STREQUAL "interpreter")
