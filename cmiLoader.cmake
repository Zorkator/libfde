...
function(add_archive_url PROJECT_NAME PROJECT_URL)
  ...
  if(DEFINED ${PROJECT_NAME}_URL_CURRENT AND NOT ("${${PROJECT_NAME}_URL}" STREQUAL "${${PROJECT_NAME}_URL_CURRENT}"))
    unset(${PROJECT_NAME}_DIR CACHE)
  endif()
  set(${PROJECT_NAME}_URL_CURRENT "${${PROJECT_NAME}_URL}" CACHE INTERNAL "")
  
  get_filename_component(${PROJECT_NAME}_ARCHIVE "${${PROJECT_NAME}_URL}" NAME)
  set(${PROJECT_NAME}_ARCHIVE_PATH "${cmi_EXTERNALS_DIR}/${${PROJECT_NAME}_ARCHIVE}" CACHE PATH "")
  get_filename_component(${PROJECT_NAME}_ARCHIVE_TAG "${${PROJECT_NAME}_ARCHIVE_PATH}" NAME_WE) 
  
  set(cmi_DIR "${cmi_EXTERNALS_DIR}/${${PROJECT_NAME}_ARCHIVE_TAG}" CACHE PATH "")
  if(NOT EXISTS "${${PROJECT_NAME}_DIR}")
    if(NOT EXISTS "${${PROJECT_NAME}_ARCHIVE_PATH}")
      message(STATUS "Downloading ${PROJECT_NAME}")
      file(DOWNLOAD "${${PROJECT_NAME}_URL}" "${${PROJECT_NAME}_ARCHIVE_PATH}" SHOW_PROGRESS)
    endif()
