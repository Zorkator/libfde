...
dynstring: dynamic_string.f90
	$(mk_F90C) $(mk_F90_FLAGS) -DTEST $(mk_INCLUDE_PATHLIST) $< -o $@.$(mk_TAG)

gref: gref_test.f90
	$(mk_F90C) $(mk_F90_FLAGS) $(mk_INCLUDE_PATHLIST) -c dynamic_string.f90
	$(mk_F90C) $(mk_F90_FLAGS) -DTEST $(mk_INCLUDE_PATHLIST) $< dynamic_string.o -o $@.$(mk_TAG)
...
varitem: var_item.f90 gref_test.f90
	...
	$(mk_F90C) $(mk_F90_FLAGS) -DTEST $(mk_INCLUDE_PATHLIST) $< gref_test.o dynamic_string.o -o $@.$(mk_TAG)
