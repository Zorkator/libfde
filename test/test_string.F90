...
contains
  ...
  subroutine test_file_string()!{{{
    ...
    print *, basename("\.testinger")
    print *, basename("/.testinger\bla")
    print *, basename(".testinger")
    print *, basename("testinger.f90")
    print *, basename("path\testinger.f90")
    print *, basename("c:\path/testinger.f90")
    print *, basename("path/testinger")
    print *, basename("testinger")

    print *, dirname("c:\path/testinger.f90")
...
#   define _cmp(this,to)              \
    ...
    _assert( filename( ds2 ) == 'test_string.F90' )
    _assert( dirname( ds2 ) == 'test/' )
    _assert( basename( ds2 ) == 'test_string' )
